...
// - the path provided in the NIM environment variable (takes precedence if present).
...
//   installers use.  This is how I imagine a more "permanent" hybridiztion might look.
// - A `nim` found in the path (lowest precedence).
// Note that (for now) the user must have separately established a Nimbella current namespace.
